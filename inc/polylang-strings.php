...
function tenjoy_strings(): array
{
    ...
    $strings = [
        ...
        'company_25' => ['text' => '九州エリア', 'group' => '会社概要ページ'],
        'company_26' => ['text' => '福岡・佐賀・長崎・熊本・大分・宮崎・鹿児島', 'group' => '会社概要ページ'],
        'company_27' => ['text' => '関西・中国エリア', 'group' => '会社概要ページ'],
        'company_28' => ['text' => '大阪・京都・兵庫・広島・岡山・山口', 'group' => '会社概要ページ'],
        'company_29' => ['text' => '全国対応', 'group' => '会社概要ページ'],
        'company_30' => ['text' => '上記以外のエリアもご相談ください。全国のゴルフ場への手配が可能です。', 'group' => '会社概要ページ'],
        ...
        'company_home_04' => ['text' => '関東エリア', 'group' => 'トップ：会社概要'],
        'company_home_05' => ['text' => '東京、神奈川、千葉、埼玉、茨城、群馬、栃木', 'group' => 'トップ：会社概要'],
        'company_home_06' => ['text' => '関西エリア', 'group' => 'トップ：会社概要'],
        'company_home_07' => ['text' => '大阪、京都、兵庫、奈良、和歌山、滋賀', 'group' => 'トップ：会社概要'],
        'company_home_08' => ['text' => 'その他の地域', 'group' => 'トップ：会社概要'],
        'company_home_09' => ['text' => 'お問い合わせください', 'group' => 'トップ：会社概要'],
