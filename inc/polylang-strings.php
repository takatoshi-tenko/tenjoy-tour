...
function tenjoy_strings(): array
{
    ...
    $strings = [
        ...
        'contact_26' => ['text' => 'お問い合わせを受け付けました。ありがとうございます。内容を確認のうえ、ご連絡いたします。', 'group' => 'お問い合わせページ'],
        'contact_27' => ['text' => '送信に失敗しました。時間をおいて再度お試しください。', 'group' => 'お問い合わせページ'],
        'contact_28' => ['text' => '必須項目を正しく入力してください。', 'group' => 'お問い合わせページ'],
        'contact_32' => ['text' => 'よくある質問をもっと見る', 'group' => 'お問い合わせページ'],
        ...
        'faq_03' => ['text' => 'FAQはただいま準備中です。もうしばらくお待ちください。', 'group' => 'よくある質問ページ'],
