...
<main id="main" class="site-main" role="main">
  ...
  <div class="archive-header">
    <div class="container">
      <h1 class="archive-title"><?php esc_html_e('アクティビティ', 'tenjoy-tour'); ?></h1>
      <p class="archive-desc">
        <?php esc_html_e('日本各地でゴルフと合わせて楽しめるアクティビティをご紹介します', 'tenjoy-tour'); ?>
      </p>
    </div>
  </div>
  ...
  <div class="activities-archive">
    <div class="container">
      ...
      <?php else : ?>
        <p class="archive-empty"><?php esc_html_e('アクティビティ情報は準備中です。', 'tenjoy-tour'); ?></p>
      <?php endif; ?>
    </div>
  </div>
